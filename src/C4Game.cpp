...
bool C4Game::OpenScenario()
{
	...
	{
		LogFatal(FormatString(LoadResStr("IDS_PRC_NOREQC4X"), MainSection.C4S.Head.C4XVer[0], MainSection.C4S.Head.C4XVer[1], MainSection.C4S.Head.C4XVer[2], MainSection.C4S.Head.C4XVer[3], MainSection.C4S.Head.C4XVer[4]).getData());
		return false;
	}
...
bool C4Game::Init()
{
	...
	// Start message
	Log(LoadResStr(MainSection.C4S.Head.NetworkGame ? "IDS_PRC_JOIN" : MainSection.C4S.Head.SaveGame ? "IDS_PRC_RESUME" : "IDS_PRC_START"));
...
{
	LogF("LoadScenarioSection: broken");
	return false;
#if 0
