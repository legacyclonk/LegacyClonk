...
bool C4Game::InitKeyboard()
{
	...
	constexpr auto keyWithGamepadGuiControl = [](auto keyboardKey, C4KeyCode gamepadButton, auto... moreKeyboardKeys) -> C4CustomKey::CodeList
	{
		if (Config.Controls.GamepadGuiControl)
		{
			return {C4KeyCodeEx(keyboardKey), moreKeyboardKeys..., C4KeyCodeEx(KEY_Gamepad(0, gamepadButton))};
		}
		else
		{
			return {C4KeyCodeEx(keyboardKey), moreKeyboardKeys...};
		}
	};
