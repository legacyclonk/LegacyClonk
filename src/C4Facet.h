...
public:
	...
	void DrawXLimited(C4Surface *sfcTarget, std::int32_t sourceWidth, std::int32_t sourceHeight, std::int32_t targetX, std::int32_t targetY, std::int32_t targetWidth, std::int32_t targetHeight, float scale = 1.0f) const;
	...
	void DrawLimited(C4Surface *sfcTarget, std::int32_t sourceWidth, std::int32_t sourceHeight, std::int32_t targetX, std::int32_t targetY, float scale = 1.0f) const;
