...
#define C4CFN_Script           "Script.c|Script{}.c|C4Script{}.c"
#define C4CFN_ScriptStringTbl  "StringTbl.txt|StringTbl{}.txt"
...
#define C4CFN_Title            "Title{}.txt|Title.txt"
...
#define C4CFN_ScenarioDesc     "Desc{}.rtf"
...
#define C4CFN_DefNames         "Names{}.txt|Names.txt"
#define C4CFN_DefActMap        "ActMap.txt"
#define C4CFN_DefDesc          "Desc{}.txt"
...
#define C4CFN_ClonkNames       "ClonkNames{}.txt|ClonkNames.txt"
#define C4CFN_ClonkNameFiles   "ClonkNames*.txt"
#define C4CFN_RankNames        "Rank{}.txt|Rank.txt"
...
#define C4FLS_Def              "Particle.txt|DefCore.txt|Graphics.bmp|Graphics.png|Overlay.png|Graphics*.png|Overlay*.png|Portrait*.png|Portrait*.bmp|ActMap.txt|Script.c|Script*.c|C4Script.c|StringTbl*.txt|Names*.txt|Title*.txt|ClonkNames.txt|" C4CFN_RankNameFiles "|Rank.bmp|Rank.png|Desc*.txt|Overlay.png|Title.bmp|Title.png|Icon.bmp|Author.txt|Version.txt|" C4CFN_SoundFiles "|*.c4d"
#define C4FLS_Player           "Player.txt|Portrait.png|Portrait.bmp|*.c4i"
#define C4FLS_Object           "ObjectInfo.txt|Portrait.png|Portrait.bmp"
#define C4FLS_Folder           "Folder.txt|Title*.txt|Info.txt|Desc*.rtf|Title.png|Title.bmp|Icon.png|Icon.bmp|Author.txt|Version.txt|*.c4s|*.c4f|Loader*.bmp|Loader*.png|Loader*.jpeg|Loader*.jpg|FolderMap.txt|FolderMap.png|*.png"
