...
public:
	...
	virtual bool PrepareRendering(CSurface *) override { return true; }
	virtual void FillBG(uint32_t dwClr = 0) override {}
	virtual void PerformBlt(CBltData &, CTexRef *, uint32_t, bool, bool) override {}
	virtual void DrawLineDw(CSurface *, float, float, float, float, uint32_t) override {}
	virtual void DrawQuadDw(CSurface *, int *, uint32_t, uint32_t, uint32_t, uint32_t) override {}
	virtual void DrawPixInt(CSurface *, float, float, uint32_t) override {}
