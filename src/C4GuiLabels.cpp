...
TextWindow::TextWindow(const C4Rect &rtBounds, std::int32_t iPicWdt, std::int32_t iPicHgt, std::int32_t iPicPadding, size_t iMaxLines, size_t iMaxTextLen, const char *szIndentChars, bool fAutoGrow, const OverlayFrameSpec *pOverlayPic, int iOverlayBorder, bool fMarkup, bool keepPictureAspectRatio)
