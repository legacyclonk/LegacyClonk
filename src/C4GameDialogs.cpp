...
C4AbortGameDialog::C4AbortGameDialog()
	: C4GUI::Dialog((Game.Control.isCtrlHost() || (Game.MainSection.C4S.Head.Film == 2)) ? 400 : C4GUI::MessageDialog::dsSmall, 100, LoadResStr("IDS_DLG_ABORT"), false), fGameHalted(false)
{
