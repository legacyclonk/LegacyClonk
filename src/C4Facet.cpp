...
void C4Facet::DrawLimited(C4Surface *const sfcTarget, const std::int32_t sourceWidth, const std::int32_t sourceHeight, const std::int32_t targetX, const std::int32_t targetY, const float scale) const
{
...
void C4Facet::DrawXLimited(C4Surface *const sfcTarget, const std::int32_t sourceWidth, const std::int32_t sourceHeight, const std::int32_t targetX, const std::int32_t targetY, const std::int32_t targetWidth, const std::int32_t targetHeight, float scale) const
{
	if (!lpDDraw || !Surface || !sfcTarget || !sourceWidth || !sourceHeight)
	{
		return;
