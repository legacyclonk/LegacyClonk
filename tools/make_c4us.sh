...
# example usage: OLDOBJVERSION=4,9,10,7 OBJVERSION=4.9.10.7 VERSION=334 C4GROUP=~/clonk/c4group64 ./make_c4us.sh
...
if [ -z "$VERSION" ]; then
	echo "Please define the environment variable VERSION and tell what version this will be (e.g. 334)" >&2
	exit 1
fi
